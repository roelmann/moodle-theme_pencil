...
$page = new admin_settingpage('theme_pencil_presets', get_string('presets_settings', 'theme_pencil'));

// Preset.
$name = 'theme_pencil/preset';
$title = get_string('preset', 'theme_pencil');
$description = get_string('preset_desc', 'theme_pencil');
$presetchoices = '';
// Add preset files from theme preset folder.
$iterator = new DirectoryIterator($CFG->dirroot . '/theme/pencil/scss/preset/');
...
$fs = get_file_storage();
$files = $fs->get_area_files($context->id, 'theme_pencil', 'preset', 0, 'itemid, filepath, filename', false);
...
$name = 'theme_pencil/presetfiles';
$title = get_string('presetfiles', 'theme_pencil');
$description = get_string('presetfiles_desc', 'theme_pencil');
